package org.foxy.foxy.connect.fragment
...
class LoginFragment : Fragment(), IConnectView {
    ...
    fun loginFacebook() {
        LoginManager.getInstance().logInWithReadPermissions(this,
                Arrays.asList("email", "public_profile", "user_friends", "user_birthday"))
    }
